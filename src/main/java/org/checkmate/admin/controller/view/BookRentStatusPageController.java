...
/**
 * 도서 대여 현황 HISTORY1: 최초 생성                              [이준희  2024.07.28]
 */
public class BookRentStatusPageController implements Initializable {
  ...
  private void loadData() throws SQLException {
    loginId.setCellValueFactory(
        new PropertyValueFactory<ReadBookLoanRecordsResponseDto, String>("loginId"));
    eName.setCellValueFactory(
        new PropertyValueFactory<ReadBookLoanRecordsResponseDto, String>("eName"));
    dName.setCellValueFactory(
        new PropertyValueFactory<ReadBookLoanRecordsResponseDto, String>("dName"));
    tName.setCellValueFactory(
        new PropertyValueFactory<ReadBookLoanRecordsResponseDto, String>("tName"));
    bName.setCellValueFactory(
        new PropertyValueFactory<ReadBookLoanRecordsResponseDto, String>("bName"));
    loanDate.setCellValueFactory(
        new PropertyValueFactory<ReadBookLoanRecordsResponseDto, Date>("loanDate"));
    returnPreDate.setCellValueFactory(
        new PropertyValueFactory<ReadBookLoanRecordsResponseDto, Date>("returnPreDate"));
  ...
  private void addButtonToTable() {
    Callback<TableColumn<ReadBookLoanRecordsResponseDto, Void>, TableCell<ReadBookLoanRecordsResponseDto, Void>> cellFactory = new Callback<>() {
      @Override
      public TableCell<ReadBookLoanRecordsResponseDto, Void> call(
          final TableColumn<ReadBookLoanRecordsResponseDto, Void> param) {
